    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden">
            <div class="p-12 bg-blue-600 text-white relative overflow-hidden">
                ...
                <p class="mt-4 font-bold text-blue-100 uppercase tracking-widest text-xs tracking-widest">Architecture • Chart of Accounts Expansion</p>
            </div>
            ...
            <form action="{{ route('finance.accounts.store') }}" method="POST" class="p-12 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Account Code</label>
                    ...
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Account Name</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Account Type</label>
                    ...
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Category (Optional)</label>
                ...
                <div class="pt-6">
                    ...
                    <div class="text-center mt-6">
                        <a href="{{ route('finance.accounts.index') }}" class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] hover:text-slate-600 transition-colors">Discard & Return to List</a>
                    </div>
                </div>
            </form>
        </div>
