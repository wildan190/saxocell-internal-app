...
<div class="content-wrapper bg-slate-50/50 min-h-screen pb-20 p-8 md:p-12">
    <div class="max-w-3xl mx-auto">
        <div class="mb-12">
            <h1 class="text-5xl font-black text-slate-900 tracking-tight">New Reconciliation</h1>
        ...
        <div class="bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden">
            <div class="p-12 bg-blue-600 text-white relative overflow-hidden">
                ...
                <h3 class="text-2xl font-black italic tracking-tighter uppercase tracking-widest text-blue-100/50">Initial Configuration</h3>
            </div>
            ...
            <form action="{{ route('finance.reconciliations.store') }}" method="POST" class="p-12 space-y-10">
                ...
                <div class="space-y-3">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Select Bank Account</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Statement Date</label>
                    ...
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Statement Ending Balance</label>
                ...
                <div class="pt-6">
                    ...
                    <p class="text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-6">You will select book entries to match against this statement in the next step</p>
                </div>
            </form>
        </div>
    </div>
