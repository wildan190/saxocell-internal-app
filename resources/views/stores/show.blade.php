                ...
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6 relative z-10">
                        <h3 class="text-sm font-black text-white uppercase tracking-widest flex items-center gap-3">
                            <span class="w-8 h-8 bg-white/10 text-emerald-400 rounded-lg flex items-center justify-center">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('stores.income.create', $store) }}" class="px-4 py-2 bg-emerald-500 hover:bg-emerald-400 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-lg shadow-emerald-900/20 flex items-center gap-2">
                                <i data-feather="plus" class="w-3 h-3"></i> Income
                            </a>
                            <a href="{{ route('stores.transfer.create', $store) }}" class="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                        ...
                        <div class="col-span-2 text-center py-4 text-slate-500 text-sm italic">
                            No accounts linked to this store. Click "Add Account" to get started.
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div id="add-account-modal" class="hidden fixed inset-0 z-[100] overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen px-4">
                    ...
                    <div class="bg-white rounded-[2.5rem] overflow-hidden shadow-2xl transform transition-all sm:max-w-lg sm:w-full relative z-20 border border-slate-100">
                        ...
                        <form action="{{ route('stores.accounts.store', $store) }}" method="POST" class="p-8 space-y-5">
                            @csrf
                            <div>
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Account Code</label>
                                <input type="text" name="code" placeholder="e.g. 1101-STR" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 font-semibold text-slate-700 focus:outline-none focus:border-blue-500 transition-colors" required>
                            </div>
                            
                            <div>
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Account Name</label>
                                <input type="text" name="name" placeholder="e.g. Store Petty Cash" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 font-semibold text-slate-700 focus:outline-none focus:border-blue-500 transition-colors" required>
                            </div>
