...
@section('title', 'Transfer Funds: ' . $store->name)
...
<div class="content-wrapper bg-slate-50/50 min-h-screen pb-20">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
            ...
            <p class="text-slate-500 mt-2 font-medium text-sm">Transfer from {{ $store->name }} to another entity.</p>
        </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('stores.transfer.store', $store) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="description" placeholder="e.g. Cash Deposit to Warehouse" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 font-semibold text-slate-700 focus:outline-none focus:border-blue-500 transition-colors">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        <h3 class="font-bold text-slate-900 flex items-center gap-2">
                            <i data-feather="upload" class="w-4 h-4 text-rose-500"></i> From (This Store)
                        </h3>
                        <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="destType" name="destination_type" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 font-semibold text-slate-700 focus:outline-none focus:border-blue-500 transition-colors mb-3">
                                ...
                                <option value="store">Other Store</option>
                            </select>
