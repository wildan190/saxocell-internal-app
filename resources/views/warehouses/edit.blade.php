...
<div class="content-wrapper">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Update details for <strong>{{ $warehouse->name }}</strong>.</p>
        </div>
    </div>

    <form action="{{ route('warehouses.update', $warehouse) }}" method="POST" class="card">
        @csrf
        @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" 
                              rows="3" 
                              class="form-control">{{ old('description', $warehouse->description) }}</textarea>
                </div>
            </div>
        </div>
