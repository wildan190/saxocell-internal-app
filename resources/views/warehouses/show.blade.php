                     ...
                     <div class="flex items-center justify-between mb-6 relative z-10">
                        <h3 class="text-sm font-black text-white uppercase tracking-widest flex items-center gap-3">
                         ...
                         <div class="flex gap-2">
                            ...
                            <a href="{{ route('warehouses.pay-supplier.create', $warehouse) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-400 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-lg shadow-blue-900/20 flex items-center gap-2">
                                <i data-feather="credit-card" class="w-3 h-3"></i> Pay Supplier
                            </a>
