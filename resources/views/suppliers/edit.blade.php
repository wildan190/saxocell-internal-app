    ...
    <div class="form-section">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="contact_person" name="contact_person" class="form-input" value="{{ old('contact_person', $supplier->contact_person) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="identity_card_number" name="identity_card_number" class="form-input" value="{{ old('identity_card_number', $supplier->identity_card_number) }}">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" class="form-input" value="{{ old('phone', $supplier->phone) }}" required>
                @error('phone')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-group">
            ...
            <textarea id="address" name="address" class="form-textarea" rows="3">{{ old('address', $supplier->address) }}</textarea>
            @error('address')
                <span class="error-message">{{ $message }}</span>
            @enderror
        </div>
